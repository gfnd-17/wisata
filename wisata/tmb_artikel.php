...
<head>
  ...
  <title>Pariwisata | Tambah Artikel</title>
      ...
      <div class="container w-50" data-aos="fade-up" data-aos-delay="100">
        <div class="comments">
              <div class="reply-form">
                <form action="assets/php/tambah_artikel.php" method="POST" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col form-group">
                      <input name="nama" type="text" class="form-control" placeholder="Judul Artikel">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                      <textarea name="isi" class="form-control" placeholder="Isi Artikel"></textarea>
                    </div>
                  </div>
                  <div class="row">
