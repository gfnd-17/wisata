...
<head>
  ...
  <title>Pariwisata | Candi Borobudur</title>
  ...
  <main id="main">
    ...
    <section id="blog" class="blog">
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <?php 
          $tmp = "SELECT * FROM artikel WHERE id='$lock'";
          $kueri = mysqli_query($db, $tmp);
        ...
        <div class="row g-5">
          ...
          <div class="col">
            ...
            <article class="blog-details">
              ...
              <div class="post-img">
                <?php echo "<img src='file/$dt[gambar]' class='img-fluid'>"; ?>
              </div>

              <h2 class="title"><?php echo $dt['nama']; ?></h2>
